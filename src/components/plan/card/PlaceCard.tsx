...
interface PlaceCardProps {
  ...
  const PlaceCard = ({ color, site }: PlaceCardProps) => {
    ...
    return (
        <>
            {edit ?
                <div style={{ width: `${select ? '340px' : '320px' }`,
                height:'230px',
                position:'relative',
                borderRadius:'8px',
                display:'flex', 
                ...
                alignItems:'center',
                padding:`${select ? '20px 10px 16px 10px' : '0' }`, 
                background:'#FAFAFA',
                marginBottom:'20px',
            ...
            :
                ...
                >
                    <div style={{width:'26px',display:'flex', flexDirection:'column',alignItems:'center'}}>
                        <div style={{width:'100%', lineHeight:'26px', background:`${color}`, borderRadius:'50%', color:'white',textAlign:'center'}}>{site.id}</div>
                    ...
                    <div style={{ width:'282px' }}>
                        ...
                        <div style={{display: select ? 'block' : 'none', transition: 'all 0.1s ease',}}>
